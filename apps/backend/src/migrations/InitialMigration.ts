...
export class InitialMigration extends Migration {
  async up(): Promise<void> {
    ...
    this.addSql('alter table `article_co_authors` add primary key `article_co_authors_pkey`(`user_id`, `article_id`);');
    ...
    this.addSql('alter table `article` add `last_activity` datetime null;');
